...
const hostelAttendanceRoutes = require("./routes/hostelAttendanceRoutes");
const hostelSupervisorRoutes = require("./routes/hostelSupervisorRoutes");
...
app.use("/api/hostel-supervisor", hostelSupervisorRoutes);
