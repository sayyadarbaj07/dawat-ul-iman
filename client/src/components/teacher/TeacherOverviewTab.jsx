        ...
        <Card className="shadow-sm">
          ...
          <CardContent className="pt-4 space-y-4">
            <div className="flex items-center gap-3 bg-muted/30 p-3 rounded-lg border">
              ...
              <div>
                <div className="text-xs text-muted-foreground font-semibold uppercase">Classes & Subjects</div>
                <div className="font-medium text-sm mt-0.5">Classes: {teacher?.assignedClassIds?.length || 0}</div>
                <div className="font-medium text-sm mt-0.5">Subjects: {teacher?.teachingAssignments ? Array.from(new Set(teacher.teachingAssignments.map(a => a.subjectId))).length : 0}</div>
              </div>
            </div>
